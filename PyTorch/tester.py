...
for i in range(n):
    ...
    input_data2 = torch.tensor(
        [[random.uniform(0, 5), random.uniform(3, 5), random.uniform(3, 5), random.uniform(3, 5)]],
        dtype=torch.float32)
    # pictogramandtext
    input_data3 = torch.tensor(
        [[random.uniform(0, 5), random.uniform(4, 5), random.uniform(3, 5), random.uniform(4, 5)]],
        dtype=torch.float32)
...
print("Success rate:", correct_predictions / (n * 3))
...
print("Motorics: ", input_data4[0][0].item())
print("Sensory insensitiveness: ", input_data4[0][1].item())
